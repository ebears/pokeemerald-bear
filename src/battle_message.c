...
static const u8 sText_CriticalHit[] = _("{COLOR RED}A critical hit!{COLOR DARK_GRAY}");
static const u8 sText_OneHitKO[] = _("It's a {COLOR RED}one-hit KO{COLOR DARK_GRAY}!");
...
static const u8 sText_NotVeryEffective[] = _("{COLOR DARK_GRAY}It's {COLOR RED}not very effective{COLOR DARK_GRAY}…");
static const u8 sText_SuperEffective[] = _("{COLOR DARK_GRAY}It's {COLOR BLUE}super effective{COLOR DARK_GRAY}!");
static const u8 sText_GotAwaySafely[] = _("{PLAY_SE SE_FLEE}{COLOR GREEN}Got away safely!{COLOR DARK_GRAY}\p");
...
static const u8 sText_CantEscape[] = _("{COLOR RED}Can't escape!{COLOR DARK_GRAY}\p");
...
static const struct BattleWindowText sTextOnWindowsInfo_Normal[] =
{
    ...
    [B_WIN_TYPE_SUP_EFF] = { // 24 "type" super-effective
    	.fillValue = PIXEL_FILL(0xE),
    	.fontId = 7,
    	.x = 0,
    	.y = 1,
    ...
    [B_WIN_TYPE_NOT_EFF] = { // 25 "type" not very effective
    	.fillValue = PIXEL_FILL(0xE),
    	.fontId = 7,
    	.x = 0,
    	.y = 1,
